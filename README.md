...
It's assumed that the user won't be using more than 50 threads for the work on. Therefore, if more than 50 threads are returned, only the top 50 most used threads will be added to the output image.
